...
declare namespace chrome {
  ...
  export namespace runtime {
    ...
    /**
     * Connects to a native application in the host machine. See [Native Messaging](https://developer.chrome.com/extensions/develop/concepts/native-messaging) for more information.
     *
